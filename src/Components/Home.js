...
const EmailSelectionCard = (props) => {
    return (
        <Card sx={{ mx: 'auto', width: '60vw', mt: 8 }} className="border border-info">
            <CardHeader
                title={<h4 className='d-flex justify-content-center'>User name selection</h4>}
...
const CenteredCard = (props) => {
    return (
        <Card sx={{ mx: 'auto', width: '80vw', mt: 8 }}>
            {props.children}
        </Card>
    )
}
            ...
            <EmailSelectionCard>
                <div className="container border border-primary">
                    <div className="row">
                        ...
                        <div className="col-2">
                            <button type="button" className="btn btn-primary" onClick={(e) => loginUser(e)}>Go!</button>
                        </div>
                    </div>
                </div>
            </EmailSelectionCard>
            ...
            <CenteredCard>
                <div>
                    ...
                    <div className="border border-primary">
                        <div className="row">
                            <button type="button" className='btn btn-light mr-1 col-md-1'
                            ...
                            <button type="button" className='btn btn-light mr-1 col-md-1 float-end'
                            ...
                            {messages?.map((msg) =>
                                <tr key={msg.MsgId}>
                                    ...
                                    <td className="word-wrap: break-word;min-width: 320px;max-width: 320px;">
                                        {msg.MsgBody}</td>
                                    <td>{new Date(msg.SendTime).toISOString().slice(0, 19).replace('T', ' ')}</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
                            ...
                            <div className='modal-content'>
                                ...
                                <div className='modal-body'>
                                    ...
                                    <button type="button" className='btn btn-primary float-start'
                                        onClick={() => createClick()}>Send</button>
                                </div>
                            </div>
                        </div>
                    </div>
